...
public class PoseDetection : MonoBehaviour
{
    ...
    public Vector3[] CurrentKeypoints { get; private set; } = new Vector3[k_NumKeypoints];
    ...
    void Update()
    {
        ...
        if (Time.time - lastDetectionTime > detectionInterval)
        {
            ...
            _ = Detect(webcamTexture); // correr async sin bloquear
        }
    }
    ...
    async Awaitable Detect(Texture texture)
    {
        ...
        for (var i = 0; i < k_NumKeypoints; i++)
        {
            ...
            CurrentKeypoints[i] = position_WorldSpace;
        }
    }
